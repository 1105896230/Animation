...
public class FloatingHeaderTitleBehavior extends CoordinatorLayout.Behavior<View>{
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, View child, View dependency) {
        ...
        // background change
        int startColor =child.getResources().getColor(R.color.init_bg_color);
        int endColor = child.getResources().getColor(R.color.end_bg_color);
    ...
    private int getCollapsedHeight(){
        return context.getResources().getDimensionPixelOffset(R.dimen.collapsedTitleHeight);
    }
}
